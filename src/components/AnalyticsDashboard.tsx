    ...
    <div className='flex flex-col gap-6'>
      <div className='grid w-full mx-auto grid-cols-1 sm:grid-cols-2 gap-6'>
        <Card className='w-full mx-auto max-w-xs'>
          <p className=' text-dark-tremor-content text-tremor-default'>
            Avg. visitors/day
          </p>
        ...
        <Card className='w-full mx-auto max-w-xs'>
          <p className='flex items-center gap-2.5 text-dark-tremor-content text-tremor-default'>
            Visitors today
            <Badge
              percentage={
        ...
        <div className='cols-span-3 flex items-center justify-between flex-wrap gap-8'>
          {topCountries?.map(([countryCode, number]) => {
            return (
              ...
              >
                <p className='hidden sm:bloc text-tremor-content'>
                  {countryCode}
                </p>
                <ReactCountryFlag
